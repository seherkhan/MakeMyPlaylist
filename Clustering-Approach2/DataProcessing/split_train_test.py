...
def split_train_test(dataset_csv, user_data_csv, dest_train, dest_test):
   #read the dataset_csv and store it in a list
    ...
    test_users_len = int(len(users) * 0.1)
...
split_train_test('dataset_cleaned.csv', 'new_train_triplets_final.csv', 'training_triplets_final_sep.csv', 'test_triplets_final_sep.csv')
